 ...
 */
const ENTRIES = [
  { label: "Builder", dot: "bg-builder", line: "I ship." },
  { label: "Mind", dot: "bg-signal", line: "I think about thinking." },
  { label: "Human", dot: "bg-human", line: "I'm alive outside the terminal." },
];
